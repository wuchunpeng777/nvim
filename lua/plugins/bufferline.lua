return {
    ...
    config = function()
        ...
        bufferline.setup {
            ...
            vim.keymap.set("n", "<leader>j", "<cmd>BufferLineMovePrev<cr>", {}),
            vim.keymap.set("n", "<leader>k", "<cmd>BufferLineMoveNext<cr>", {}),
            vim.keymap.set("n", "<leader>bp", "<cmd>BufferLinePick<cr>", {}),
            vim.keymap.set("n", "<leader>bo", "<cmd>BufferLineCloseOthers<cr>", {}),
            vim.keymap.set("n", "<leader>pp", "<cmd>BufferLineTogglePin<cr>", {}),
